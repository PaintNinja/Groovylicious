...
/**
 * An {@link ga.ozli.minecraftmods.groovylicious.transform.registroid.RegistroidAddon Registroid addon} which creates {@link net.minecraft.world.item.BlockItem block items} automatically for blocks. <br>
